...
#    - 평가 지표 : F1 score (임계값 최적화 포함)
#    - early stopping: 100 rounds로 늘림
# =======================
def objective(trial):
    params = {
        'n_estimators': 2000,  # 1000 -> 2000 증가
        'max_depth': trial.suggest_int('max_depth', 25, 330),  # 탐색 범위 확대
...
Best trial:
  ...
  Params:
    max_depth: 47
    num_leaves: 233
    learning_rate: 0.006246752083667691
    min_child_samples: 49
    subsample: 0.7663322317811129
    colsample_bytree: 0.9133442675133138
Best fold index: 4
Best fold F1 score: 0.4913
Best threshold: 0.61
'''